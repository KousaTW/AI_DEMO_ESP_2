...
(function(root, factory) {
    ...
    return (function() {
        ...
        var Decoder = function(parOptions) {
            ...
            var instance = this;
            this.onPictureDecoded = function(buffer, width, height, infos) { // implement in line 1709 or 1736 or 1752
            };
            ...
            ModuleCallback(function(Module) {
                ...
                if (instance.options.sliceMode) {
                    ...
                    instance.decode = function decode(typedAr, parInfo) {
						/*
                        console.log("non-slice ---> decoding:", typedAr.length, "bytes", typeof typedAr);
						var r5bits = typedAr[0] & 0x1f;
						if (r5bits >= 1 &&r5bits <= 5) {
							...
							console.log("----------- unknown:", r5bits);
						}
						console.log(toHexString(typedAr));
						*/
                        // collect infos
                        if (parInfo) {
                            instance.infoAr.push(parInfo);
